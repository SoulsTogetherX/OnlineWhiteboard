...
// alongside the real ToolTypes rather than in the shared draw protocol. (Was
// exported from the old ToolMenu; it now lives with the tool descriptors.)
...
//#region Icons
// Decorative — the descriptor's `name` carries the accessible label.
const PencilIcon = (
...
//#region Descriptors
// The canonical tool order + metadata, shared by the picker and the keymap.
export const TOOLS: ToolDescriptor[] = [
  { id: "pencil", name: "Pencil", shortcut: "P", usesStroke: true, icon: PencilIcon },
  { id: "eraser", name: "Eraser", shortcut: "E", usesStroke: true, icon: EraserIcon },
  { id: "bucket", name: "Fill", shortcut: "F", usesStroke: false, icon: BucketIcon },
  { id: "spray", name: "Spray", shortcut: "S", usesStroke: false, icon: SprayIcon },
  { id: "eyedropper", name: "Eyedropper", shortcut: "I", usesStroke: false, icon: EyedropperIcon },
]
