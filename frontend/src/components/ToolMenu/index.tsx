  ...
  return (
    <div className={`tool-menu ${isOpen ? OPEN_TOOL_CLASS : ""}`}>
      <ul className="tool-list">
        <li>
          <button className="tool-button" onClick={() => setTool("pencil")}>
            <svg
        ...
        <li>
          <button className="tool-button" onClick={() => setTool("eraser")}>
            <svg
              className="button-icon"
              fill="currentColor"
              viewBox="0 0 16 16"
        ...
        <li>
          <button className="tool-button" onClick={() => setTool("spray")}>
            <svg
              className="button-icon"
              fill="currentColor"
              viewBox="0 0 16 16"
        ...
        <li>
          <button className="tool-button" onClick={() => setTool("bucket")}>
            <svg
              className="button-icon"
              fill="currentColor"
              viewBox="0 0 16 16"
